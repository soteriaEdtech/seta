...
export function SponsorsSection() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Have specific tech needs? We can integrate your tools into the curriculum",
    },
    {
      icon: Award,
      title: "Brand Visibility",
      description:
        "Position your organization as a leader in Learning & Development",
    },
    {
      icon: Heart,
      title: "CSR Impact",
      description:
        "Support upskilling and employability in the digital economy",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl lg:text-5xl font-bold text-foreground text-balance mb-6">
              Stop Searching.{" "}
              <span className="text-primary">Start Selecting.</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {benefits.map((benefit, index) => (
              <div
                key={benefit.title}
                className={`p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-2 animate-on-scroll-scale ${
                  isVisible ? "is-visible" : ""
                }`}
